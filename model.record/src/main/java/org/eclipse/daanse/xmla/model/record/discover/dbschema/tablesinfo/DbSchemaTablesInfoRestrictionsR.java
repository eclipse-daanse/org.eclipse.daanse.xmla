...
public record DbSchemaTablesInfoRestrictionsR(Optional<String> catalogName, Optional<String> schemaName,
        String tableName, TableTypeEnum tableType) implements DbSchemaTablesInfoRestrictions {
}
