...
public record ProcessR(String type, ObjectReference object, Bindings bindings, DataSource dataSource,
        DataSourceView dataSourceView, ErrorConfiguration errorConfiguration,
