...
public record TraceFilterR(NotType not, AndOrType or, AndOrType and, BoolBinop isEqual, BoolBinop notEqual,
        BoolBinop less, BoolBinop lessOrEqual, BoolBinop greater, BoolBinop greaterOrEqual, BoolBinop like,
