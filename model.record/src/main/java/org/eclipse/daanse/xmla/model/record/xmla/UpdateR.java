...
public record UpdateR(XmlaObject object, List<AttributeInsertUpdate> attributes, Boolean moveWithDescendants,
        Boolean moveToRoot, Where where) implements Update {
