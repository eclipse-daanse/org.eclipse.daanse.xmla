...
public record MdSchemaFunctionsRestrictionsR(Optional<String> functionName, Optional<OriginEnum> origin,
        Optional<InterfaceNameEnum> interfaceName, Optional<String> libraryName)
        implements MdSchemaFunctionsRestrictions {
