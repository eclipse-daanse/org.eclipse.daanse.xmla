...
public record MdSchemaPropertiesRestrictionsR(Optional<String> catalogName, Optional<String> schemaName,
        Optional<String> cubeName, Optional<String> dimensionUniqueName, Optional<String> hierarchyUniqueName,
        Optional<String> levelUniqueName, Optional<String> memberUniqueName, Optional<String> propertyName,
        Optional<PropertyTypeEnum> propertyType, Optional<PropertyContentTypeEnum> propertyContentType,
        Optional<PropertyOriginEnum> propertyOrigin, Optional<CubeSourceEnum> cubeSource,
