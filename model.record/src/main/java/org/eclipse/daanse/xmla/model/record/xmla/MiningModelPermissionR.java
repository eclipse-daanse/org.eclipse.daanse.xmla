...
public record MiningModelPermissionR(Optional<Boolean> allowDrillThrough, Optional<Boolean> allowBrowsing, String name,
        Optional<String> id, Optional<Instant> createdTimestamp, Optional<Instant> lastSchemaUpdate,
