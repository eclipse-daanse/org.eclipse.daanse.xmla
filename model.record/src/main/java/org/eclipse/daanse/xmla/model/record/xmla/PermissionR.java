...
public record PermissionR(String name, Optional<String> id, Optional<Instant> createdTimestamp,
        Optional<Instant> lastSchemaUpdate, Optional<String> description, Optional<List<Annotation>> annotations,
        String roleID, Optional<Boolean> process, Optional<ReadDefinitionEnum> readDefinition,
        Optional<ReadWritePermissionEnum> read, Optional<ReadWritePermissionEnum> write) implements Permission {
