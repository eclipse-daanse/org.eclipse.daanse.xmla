...
public record MiningModelR(String name, Optional<String> id, Optional<Instant> createdTimestamp,
        Optional<Instant> lastSchemaUpdate, Optional<String> description, Optional<List<Annotation>> annotations,
        String algorithm, Optional<Instant> lastProcessed, Optional<List<AlgorithmParameter>> algorithmParameters,
        Optional<Boolean> allowDrillThrough, Optional<List<AttributeTranslation>> translations,
        Optional<List<MiningModelColumn>> columns, Optional<String> state,
        Optional<FoldingParameters> foldingParameters, Optional<String> filter,
        Optional<List<MiningModelPermission>> miningModelPermissions, Optional<String> language,
