...
public enum PropertyDefinition {
    AxisFormat(RowsetDefinitionType.ENUMERATION, EnumSet.allOf(XmlaConstants.AxisFormat.class),
    ...
    BeginRange(RowsetDefinitionType.INTEGER, null, XmlaConstants.Access.Write, "-1", XmlaConstants.Method.EXECUTE,
            """
    ...
    Catalog(RowsetDefinitionType.STRING, null, XmlaConstants.Access.ReadWrite, "",
    ...
    Content(RowsetDefinitionType.ENUM_STRING, EnumSet.allOf(XmlaConstants.Content.class), XmlaConstants.Access.Write,
            XmlaConstants.Content.DEFAULT.name(), XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            """
    ...
    Cube(RowsetDefinitionType.STRING, null, XmlaConstants.Access.ReadWrite, "", XmlaConstants.Method.EXECUTE,
    ...
    DataSourceInfo(RowsetDefinitionType.STRING, null, XmlaConstants.Access.ReadWrite, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "A string containing provider specific information, required to access the data source."),

    // Mondrian-specific extension to XMLA.
    Deep(RowsetDefinitionType.BOOLEAN, null, XmlaConstants.Access.ReadWrite, "", XmlaConstants.Method.DISCOVER,
    ...
    // Mondrian-specific extension to XMLA.
    EmitInvisibleMembers(RowsetDefinitionType.BOOLEAN, null, XmlaConstants.Access.ReadWrite, "",
    ...
    EndRange(RowsetDefinitionType.INTEGER, null, XmlaConstants.Access.Write, "-1", XmlaConstants.Method.EXECUTE,
    ...
    Format(RowsetDefinitionType.ENUM_STRING, EnumSet.allOf(XmlaConstants.Format.class), XmlaConstants.Access.Write,
            "Native", XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            """
    ...
    LocaleIdentifier(RowsetDefinitionType.UNSIGNED_INTEGER, null, XmlaConstants.Access.ReadWrite, "None",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            """
    ...
    Password(RowsetDefinitionType.STRING, null, XmlaConstants.Access.Read, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    StateSupport(RowsetDefinitionType.ENUM_STRING, EnumSet.allOf(XmlaConstants.StateSupport.class),
    ...
    Timeout(RowsetDefinitionType.UNSIGNED_INTEGER, null, XmlaConstants.Access.ReadWrite, "Undefined",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "A numeric time-out specifying in seconds the amount of time to wait for a request to be successful."),

    UserName(RowsetDefinitionType.STRING, null, XmlaConstants.Access.Read, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    VisualMode(RowsetDefinitionType.ENUMERATION, EnumSet.allOf(XmlaConstants.VisualMode.class),
    ...
    TableFields(RowsetDefinitionType.STRING, null, XmlaConstants.Access.Read, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
    ...
    // mondrian-specific property for advanced drill-through
    AdvancedFlag(RowsetDefinitionType.BOOLEAN, null, XmlaConstants.Access.Read, "false",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, ""),

    // Microsoft-specific XMLA definition.
    SafetyOptions(RowsetDefinitionType.INTEGER, null, XmlaConstants.Access.ReadWrite, "0",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "Determines whether unsafe libraries can be registered and loaded by client applications."),

    // Microsoft-specific XMLA definition.
    MdxMissingMemberMode(RowsetDefinitionType.STRING, null, XmlaConstants.Access.Write, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "Indicates whether missing members are ignored in MDX statements."),

    // Microsoft-specific XMLA definition.
    DbpropMsmdMDXCompatibility(RowsetDefinitionType.INTEGER, null, XmlaConstants.Access.ReadWrite, "0",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE,
            "An enumeration value that determines how placeholder members in a ragged or\n"
                    + "unbalanced hierarchy are treated."),

    // Microsoft-specific XMLA definition.
    MdpropMdxSubqueries(RowsetDefinitionType.INTEGER, null, XmlaConstants.Access.Read, "",
            XmlaConstants.Method.DISCOVER, "A bitmask that indicates the level of support for subqueries in MDX."),

    // Microsoft-specific XMLA definition.
    ClientProcessID(RowsetDefinitionType.INTEGER, null, XmlaConstants.Access.ReadWrite, "0",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, "The ID of the client process."),
...
//            ""),
    ...
    // Microsoft-specific XMLA definition.
    SspropInitAppName(RowsetDefinitionType.STRING, null, XmlaConstants.Access.ReadWrite, "",
            XmlaConstants.Method.DISCOVER_AND_EXECUTE, "The name of the client application."),
