...
public interface MdSchemaMembersRestrictions {
    ...
    /**
     * Applies only to a single member: 0x20 - Returns all of the ancestors. 0x01 - Returns only the
     * immediate children. 0x02 - Returns members on the same level. 0x04 - Returns only the immediate
     * parent. 0x08 – Returns only itself. 0x10 - Returns all of the descendants.
     */
