...
import org.eclipse.daanse.xmla.model.csdl.v2.bi.TAlignment;
import org.eclipse.daanse.xmla.model.csdl.v2.bi.TAssociationSet;
import org.eclipse.daanse.xmla.model.csdl.v2.bi.TContextualNameRule;
...
import org.eclipse.daanse.xmla.model.csdl.v2.bi.TSortDirection;
...
public class CsdlBiSchemaBuilderHelper {
    ...
    public void addPropertyWithCaption(TEntityType entityType, String name, String type, String caption, boolean hidden,
        ...
        if (orderByProperty != null) {
            ...
            org.eclipse.daanse.xmla.model.csdl.v2.bi.TPropertyRef propRef = biFactory.createTPropertyRef();
    ...
    public void addNavigationProperty(TEntityType entityType, String name, String relationship, String fromRole,
        ...
        org.eclipse.daanse.xmla.model.csdl.v2.bi.TNavigationProperty biNavProp = biFactory.createTNavigationProperty();
        if (contextualNameRule != null)
    ...
    public void addMeasurePropertyWithKpi(TEntityType entityType, String name, String type, int precision, int scale,
        ...
        org.eclipse.daanse.xmla.model.csdl.v2.bi.TPropertyRef goalRef = biFactory.createTPropertyRef();
        ...
        org.eclipse.daanse.xmla.model.csdl.v2.bi.TPropertyRef statusRef = biFactory.createTPropertyRef();
    ...
    public THierarchy createHierarchy(String name, String caption, String referenceName, String docSummary) {
        ...
        if (docSummary != null) {
            org.eclipse.daanse.xmla.model.csdl.v2.bi.TDocumentation hierDoc = biFactory.createTDocumentation();
