...
class ClientExecuteTest {
    ...
    void testCancel() throws Exception {
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Cancel").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Cancel/ConnectionID").isEqualTo("100");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Cancel/SessionID").isEqualTo("SessionID");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Cancel/SPID").isEqualTo("101");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Cancel/CancelAssociated").isEqualTo("true");
        // Properties
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Properties/PropertyList").exist();
        ...
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Properties/PropertyList/Catalog")
                .isEqualTo("FoodMart");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Properties/PropertyList/Format").isEqualTo("Tabular");
    ...
    void testClearCache() throws Exception {
        ...
        properties.setCatalog(Optional.of("FoodMart"));
        List<ExecuteParameter> parameters = List.of();
        ObjectReference objectReference = new ObjectReferenceR("serverID", "databaseID", "roleID", "traceID",
                "assemblyID", "dimensionID", "dimensionPermissionID", "dataSourceID", "dataSourcePermissionID",
                "databasePermissionID", "dataSourceViewID", "cubeID", "miningStructureID", "measureGroupID",
                "perspectiveID", "cubePermissionID", "mdxScriptID", "partitionID", "aggregationDesignID",
                "miningModelID", "miningModelPermissionID", "miningStructurePermissionID");
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/ClearCache").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/ClearCache/Object").exist();
        ...
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/ClearCache/Object/RoleID").isEqualTo("roleID");
        ...
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/ClearCache/Object/CubeID").isEqualTo("cubeID");
    ...
    void testStatement() throws Exception {
        ...
        StatementResponse response = client.execute().statement(statementRequest, requestMetaData, userPrincipal);
        assertThat(response).isNotNull();
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Statement").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Statement").isEqualTo(
                "select [Measures].[Sales Count] on 0, non empty [Store].[Store State].members on 1 from " + "[Sales]");
        // Properties
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Properties/PropertyList").exist();
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Properties/PropertyList/DataSourceInfo")
    ...
    void testAlter() throws Exception {
        ...
        properties.setCatalog(Optional.of("FoodMart"));
        List<ExecuteParameter> parameters = List.of();
        ObjectReference object = new ObjectReferenceR("serverID", "databaseID", "roleID", "traceID", "assemblyID",
                "dimensionID", "dimensionPermissionID", "dataSourceID", "dataSourcePermissionID",
                "databasePermissionID", "dataSourceViewID", "cubeID", "miningStructureID", "measureGroupID",
                "perspectiveID", "cubePermissionID", "mdxScriptID", "partitionID", "aggregationDesignID",
                "miningModelID", "miningModelPermissionID", "miningStructurePermissionID");

        ErrorConfiguration errorConfiguration = new ErrorConfigurationR(Optional.empty(), Optional.empty(),
                Optional.empty(), Optional.empty(), Optional.of("ReportAndStop"), Optional.of("ReportAndStop"),
                Optional.empty(), Optional.of("ReportAndStop"), Optional.empty());
        List<DataItem> keyColumns = List.of(new DataItemR("Integer", Optional.empty(), Optional.empty(),
                Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(),
                Optional.of(new ColumnBindingR("dbo_DimCustomer", "CustomerKey")), Optional.empty()));
        List<DimensionAttribute> attributes = List.of(new DimensionAttributeR("Customer Key", "Customer Key", null,
                null, "Key", null, 18484L, keyColumns, null, null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
                null, null, null, null, null));

        ProactiveCaching proactiveCaching = new ProactiveCachingR(Optional.empty(), Optional.empty(), Optional.empty(),
                Optional.of(Duration.parse("-PT1S")), Optional.of(Duration.parse("-PT1S")),
                Optional.of(Duration.parse("-PT1S")), Optional.of(Duration.parse("-PT1S")), Optional.empty());

        Dimension dimension = new DimensionR("Customer", "Dim Customer", null, null, null, null,
                new DataSourceViewBindingR("dsvAdventureWorksDW2008"), null, null, null, null, errorConfiguration, null,
                null, null, null, null, null, BigInteger.valueOf(1033l), "Latin1_General_CI_AS", "Unknown", null, null,
                proactiveCaching, null, null, null, null, attributes, null, null, null, null, null, null, null);

        MajorObject objectDefinition = new MajorObjectR(null, null, null, null, null, null, dimension, null, null, null,
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object").exist();
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition").exist();

        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object/ServerID").isEqualTo("serverID");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object/DatabaseID")
                .isEqualTo("databaseID");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object/RoleID").isEqualTo("roleID");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object/TraceID").isEqualTo("traceID");
        ...
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object/DataSourceViewID")
                .isEqualTo("dataSourceViewID");
        xmlAssert.valueByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/Object/CubeID").isEqualTo("cubeID");
        ...
        xmlAssert.nodesByXPath("/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension").exist();
        ...
        xmlAssert
                .valueByXPath(
                        "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/UnknownMemberName")
                .isEqualTo("Unknown");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/Source/DataSourceViewID")
                .isEqualTo("dsvAdventureWorksDW2008");

        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ErrorConfiguration/NullKeyNotAllowed")
                .isEqualTo("ReportAndStop");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ErrorConfiguration/KeyNotFound")
                .isEqualTo("ReportAndStop");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ErrorConfiguration/KeyDuplicate")
                .isEqualTo("ReportAndStop");

        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ProactiveCaching/SilenceInterval")
                .isEqualTo("PT-1S");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ProactiveCaching/Latency")
                .isEqualTo("PT-1S");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ProactiveCaching/SilenceOverrideInterval")
                .isEqualTo("PT-1S");
        xmlAssert.valueByXPath(
                "/SOAP:Envelope/SOAP:Body/Execute/Command/Alter/ObjectDefinition/Dimension/ProactiveCaching/ForceRebuildInterval")
                .isEqualTo("PT-1S");
    ...
    private void checkOlapInfoCube(OlapInfoCube olapInfoCube) {
        assertThat(olapInfoCube.lastSchemaUpdate()).isEqualTo(Instant.parse("2024-01-10T10:45:00.00Z"));
        assertThat(olapInfoCube.lastDataUpdate()).isEqualTo(Instant.parse("2024-01-10T10:45:00.00Z"));
