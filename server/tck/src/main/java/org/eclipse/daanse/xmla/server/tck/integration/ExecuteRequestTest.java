...
class ExecuteRequestTest {
    ...
    void testStatement(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            assertThat(d.properties()).isNotNull().satisfies(p -> {
                ...
                assertThat(p.axisFormat()).isNotNull().isPresent().contains(TUPLE_FORMAT);
            });
            assertThat(d.command()).isNotNull()
                    .satisfies(r -> assertThat(r.statement().trim()).isNotNull()
    ...
    void testClearcache(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            ...
            assertThat(d.command()).isNotNull().satisfies(r -> assertThat(r.object()).isNotNull().satisfies(o -> {
    ...
    void testCancel(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            ...
            assertThat(d.command()).isNotNull().satisfies(c -> {
    ...
    void testAlter(@InjectService XmlaService xmlaService) {
        ...
        assertThat(request).isNotNull().satisfies(d -> {
            ...
            assertThat(d.command()).isNotNull().satisfies(r -> {
                assertThat(r.object()).isNotNull();
                assertThat(r.object().databaseID()).isNotNull().isEqualTo("AdventureWorks_SSAS_Alter");
                assertThat(r.object().dimensionID()).isNotNull().isEqualTo("Dim Customer");
                assertThat(r.objectDefinition()).isNotNull()
                        .satisfies(od -> assertThat(od.dimension()).isNotNull().satisfies(dimension -> {
                            ...
                            assertThat(dimension.source()).isNotNull()
                                    .satisfies(s -> assertThat(((DataSourceViewBinding) s).dataSourceViewID())
                                            .isNotNull().isEqualTo("dsvAdventureWorksDW2008"));
                            ...
                            assertThat(dimension.attributes()).isNotNull()
                                    .satisfies(ats -> assertThat(ats.get(0)).isNotNull().satisfies(at -> {
                                        ...
                                        assertThat(at.keyColumns()).isNotNull()
                                                .satisfies(kcs -> assertThat(kcs.get(0)).isNotNull().satisfies(kc -> {
                                                    assertThat(kc.dataType()).isNotNull().isEqualTo("Integer");
                                                    assertThat(kc.source()).isNotNull().isPresent().satisfies(o -> {
                                                        assertThat(((ColumnBinding) o.get()).tableID()).isNotNull()
                                                                .isEqualTo("dbo_DimCustomer");
                                                        assertThat(((ColumnBinding) o.get()).columnID()).isNotNull()
